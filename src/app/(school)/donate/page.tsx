        ...
        <div className="container">
          ...
          <div style={{ maxWidth: 1030 }}>
            ...
            <div className="notice-box" style={{ marginTop: 16, borderLeftColor: 'var(--accent)' }}>
              <strong>개인정보 안내</strong> · 이 홈페이지는 회원가입·후원 신청 어느 단계에서도 주민등록번호를 수집하거나 저장하지 않습니다. 기부금 영수증은 국세청 홈택스 전자기부금영수증으로 발급되며, 그 과정에서 소득세법에 따라 필요한 주민등록번호는 홈택스에서 직접 처리되어 조합 홈페이지로 전달되지 않습니다.
            </div>
          </div>
        </div>
      </section>
